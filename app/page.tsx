...
export default function Home() {
  ...
  const characterReady = characterAvailable && (characterFile ? isCharacterUploadFormatSupported(characterFile.name, characterFormats) : Boolean(draft.characterAsset));
    ...
    <div className="workspace-grid">
      <section className="editor" aria-labelledby="editor-title">
        ...
        <form className="scene-form" onSubmit={onSaveShot}>
          ...
          <div className="actions"><button disabled={!project || busy !== null || !characterReady}>{busy === "shot" ? "Saving…" : shot ? "Shot saved" : "Save shot"}</button><button type="button" className="secondary" onClick={onRender} disabled={!shot || busy !== null}>{busy === "render" ? "Submitting…" : "Submit render"}</button></div>
