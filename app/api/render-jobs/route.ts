...
export async function POST(request: Request) {
  ...
  try {
    ...
    const response = NextResponse.json({ accepted: true, job: visibleJob ?? current ?? job }, { status: 202 });
